...
function Refundpolicy() {
  return (
    <div className="sm:mx-20 p-12">
      ...
      <br />
      <p>
        <span className="text-xl font-semibold">Independence and Transparency</span> <br />
        We do not receive any form of compensation, payment, or benefits from our partners or subsidiaries for providing delivery or execution services related to products or securities for which we offer investment advice.</p>
      <br />
      ...
      <p>
        ...
        <br />
        Furthermore, no claims have been filed against us since our inception. We communicate all suggested levels in writing. Therefore, any verbal communication from our directors or representatives should not be considered formal advice from our organization.
      </p >
      </div>
